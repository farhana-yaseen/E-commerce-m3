...
const Cart = () => {
  return (
    ...
    <div className="mt-10 lg:mt-16 xl:mt-10 font-serif px-2 md:px-20 lg:px-32 xl:px-32 m-auto">
         <div className="text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold underline text-center">
            ...
            <div className="xl:flex justify-center items-center gap-8 md:gap-10 xl:py-12">
            <CartItems/>
             <OrderSummary/>
            </div>
