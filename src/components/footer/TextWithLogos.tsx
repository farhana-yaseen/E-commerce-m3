...
const TextWithLogos = () => {
  return (
    <div className="w-[290px] md:w-[200px] xl:w-[248px] xl:h-[177px]">
        {/* Text */}
        <div className="xl:w-[248px] xl:h-[114px] flex flex-col justify-start gap-6 lg:gap-[25px]">  
            ...
            <h1 className="w-[280px] h-10 top-[3838.58px] left-[17px] md:w-[200px] xl:w-[248px] xl:h-[66px] font-figtree font-normal text-sm leading-[22px] opacity-60">We have clothes that suits your style and which you’re proud to wear. From women to men.</h1>
        </div>
